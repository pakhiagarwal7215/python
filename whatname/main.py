...
print("-_"*20+"AI ESSAY WRITING ASSISTANT"+"-_"*20)
topic =input("What is the topic for essay?:")
...
for i in lenght :
    print(i)
lenght = input("Enter any of the choice")
target = input("Who is your audience? (eg. college students,teacher):")
if not topic:
    topic = "art"
if not essay_type:
...
if temprature < 0.1 or temprature >1:
    print("invalid input: setting temprature to 0.3")
    temprature ="0.3"
prompt =f"Write an introduction an {essay_type} essay on the topic {topic} limited to {lenght} words"
