...
category = input(f"which category(ex.animal,food): ")
...
one_shot = f"Ex. Category:food item: pizza answers: yes pizza is a food, now answer Category:{category} and item:{item} what will be your answer? "
print(" ONE SHOT learning response is: ", generate_response(one_shot,temperature=0.3,max_tokens=1024))
...
print ("FEW SHOT learning response is: ",generate_response(few_shot,temperature=0.3,max_tokens=1024)) 
creative_prompt = f"""Write a one-sentence story about the given word. 
              ...
              Word: {item} Story:"""
print("-_-_-_-creative few_shot example -_-_-_-")
